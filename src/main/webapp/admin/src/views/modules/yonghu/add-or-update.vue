    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                   ...
                   <el-col :span="12">
                       <el-form-item class="select" v-if="type!='info'"  label="入住老人" prop="laorenTypes">
                           <el-select v-model="ruleForm.laorenTypes" placeholder="请选择入住老人">
                               <el-option
                       ...
                       <div v-else>
                           <el-form-item class="input" label="入住老人" prop="laorenTypes">
                               <el-select v-model="ruleForm.laorenTypes" placeholder="请选择入住老人" readonly>
                                   <el-option
                                           v-for="(item,index) in laorenTypesSelectSearch"
                                           v-bind:key="index"
                                           :label="item.laorenName"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                        ...
                        laorenTypes: [
                        { required: true, message: '入住老人不能为空', trigger: 'blur' },
                    ],
