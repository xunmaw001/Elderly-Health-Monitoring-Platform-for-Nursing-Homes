    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="留言信息" prop="note">
                              <el-input v-model="ruleForm.note" :disabled="liuyan"
                                        placeholder="留言信息" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="留言信息" prop="note">
                                  <el-input v-model="ruleForm.note"
                                            placeholder="留言信息" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="回复" prop="reply">
                              <el-input v-model="ruleForm.reply" :disabled="huifu"
                                        placeholder="回复" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="回复" prop="reply">
                                  <el-input v-model="ruleForm.reply"
                                            placeholder="回复" readonly></el-input>
                              </el-form-item>
                          </div>
                      </el-col>
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                                 ...
                                 if(o=='yhnote'){
                                     this.ruleForm.yhnote = obj[o];
                                     this.ro.yhnote = true;
                                     continue;
                                 }

                                 if(o=='noteTime'){
                                     this.ruleForm.noteTime = obj[o];
                                     this.ro.noteTime = true;
                                     continue;
                                 }
                                 ...
                                 if(o=='glreply'){
                                     this.ruleForm.glreply = obj[o];
                                     this.ro.glreply = true;
                                     continue;
                                 }

                                 if(o=='replyTime'){
                                     this.ruleForm.replyTime = obj[o];
                                     this.ro.replyTime = true;
                                     continue;
                                 }
                    }
                }
